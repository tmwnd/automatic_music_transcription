...
# python train.py with train_on=MAESTRO logdir=results_optional/transferred_from_MAPS_unet_model_trained_on_MAESTRO model_type=unet pretrained_model_path=results/unet_model_trained_on_MAPS/model-$epoches.pt epoches=$epoches seed=$seed
...
# python train.py with train_on=MAESTRO logdir=results_optional/transferred_unet_model_trained_on_MAESTRO model_type=unet pretrained_model_path=results/unet_model_trained_on_SynthesizedInstruments/model-$epoches.pt epoches=$epoches seed=$seed
...
# python train_reduced.py with train_on=MAESTRO logdir=results_optional/transferred_from_MAPS_unet_model_trained_on_MAESTRO_.23 model_type=unet pretrained_model_path=results/unet_model_trained_on_MAPS/model-$epoches.pt epoches=$epoches seed=$seed train_size=.23
# python train_reduced.py with train_on=MAESTRO logdir=results_optional/transferred_unet_model_trained_on_MAESTRO_.23 model_type=unet pretrained_model_path=results/unet_model_trained_on_SynthesizedInstruments/model-$epoches.pt epoches=$epoches seed=$seed train_size=.23
...
# python train.py with train_on=MAESTRO logdir=results_optional/transferred_from_GuitarSet_unet_model_trained_on_MAESTRO model_type=unet pretrained_model_path=results_optional/unet_model_trained_on_GuitarSet/model-$epoches.pt epoches=$epoches seed=$seed
# python train.py with train_on=GuitarSet logdir=results_optional/transferred_from_MAESTRO_unet_model_trained_on_GuitarSet model_type=unet pretrained_model_path=results_optional/unet_model_trained_on_MAESTRO/model-$epoches.pt epoches=$epoches seed=$seed
# python train.py with train_on=MAESTRO logdir=results_optional/transferred_from_MAPS_synthesized_unet_model_trained_on_MAESTRO model_type=unet pretrained_model_path=results_optional/unet_model_trained_on_MAPSSynthesizedInstruments/model-$epoches.pt epoches=$epoches seed=$seed

# evaluate_model results_optional/transferred_from_GuitarSet_unet_model_trained_on_MAESTRO/model-$epoches.pt
# evaluate_model results_optional/transferred_from_MAESTRO_unet_model_trained_on_GuitarSet/model-$epoches.pt
# evaluate_model results_optional/transferred_from_MAPS_synthesized_unet_model_trained_on_MAESTRO/model-$epoches.pt

# create loop for following models:
# transferred_from_GuitarSet_unet_model_trained_on_MAPS_.005
# transferred_from_GuitarSet_unet_model_trained_on_MAPS_.01
# transferred_from_GuitarSet_unet_model_trained_on_MAPS_.02
# transferred_unet_model_trained_on_GuitarSet_.005
# transferred_unet_model_trained_on_GuitarSet_.01
# transferred_unet_model_trained_on_GuitarSet_.02

# for i in $(seq 8 9);
# do
#     python train_reduced.py with train_on=MAPS logdir=results_thesis/transferred_from_GuitarSet_unet_model_trained_on_MAPS_.005_$i model_type=unet pretrained_model_path=results/unet_model_trained_on_GuitarSet/model-$epoches.pt epoches=4000 seed=$seed train_size=.005
#     python train_reduced.py with train_on=MAPS logdir=results_thesis/transferred_from_GuitarSet_unet_model_trained_on_MAPS_.01_$i model_type=unet pretrained_model_path=results/unet_model_trained_on_GuitarSet/model-$epoches.pt epoches=4000 seed=$seed train_size=.01
#     python train_reduced.py with train_on=MAPS logdir=results_thesis/transferred_from_GuitarSet_unet_model_trained_on_MAPS_.02_$i model_type=unet pretrained_model_path=results/unet_model_trained_on_GuitarSet/model-$epoches.pt epoches=4000 seed=$seed train_size=.02
# done

# for i in $(seq 8 9);
# do
#     python train_reduced.py with train_on=GuitarSet logdir=results_thesis/transferred_unet_model_trained_on_GuitarSet_.005_$i model_type=unet pretrained_model_path=results/unet_model_trained_on_SynthesizedInstruments/model-$epoches.pt epoches=4000 seed=$seed train_size=.005
#     python train_reduced.py with train_on=GuitarSet logdir=results_thesis/transferred_unet_model_trained_on_GuitarSet_.01_$i model_type=unet pretrained_model_path=results/unet_model_trained_on_SynthesizedInstruments/model-$epoches.pt epoches=4000 seed=$seed train_size=.01
#     python train_reduced.py with train_on=GuitarSet logdir=results_thesis/transferred_unet_model_trained_on_GuitarSet_.02_$i model_type=unet pretrained_model_path=results/unet_model_trained_on_SynthesizedInstruments/model-$epoches.pt epoches=4000 seed=$seed train_size=.02
# done

# for i in $(seq 8 9);
# do
#     evaluate_model results_thesis/transferred_from_GuitarSet_unet_model_trained_on_MAPS_.005_$i/model-4000.pt
#     evaluate_model results_thesis/transferred_from_GuitarSet_unet_model_trained_on_MAPS_.01_$i/model-4000.pt
#     evaluate_model results_thesis/transferred_from_GuitarSet_unet_model_trained_on_MAPS_.02_$i/model-4000.pt
# done

# for i in $(seq 8 9);
# do
#     evaluate_model results_thesis/transferred_unet_model_trained_on_GuitarSet_.005_$i/model-4000.pt
#     evaluate_model results_thesis/transferred_unet_model_trained_on_GuitarSet_.01_$i/model-4000.pt
#     evaluate_model results_thesis/transferred_unet_model_trained_on_GuitarSet_.02_$i/model-4000.pt
# done

# python train_reduced.py with train_on=MAESTRO logdir=results_optional/transferred_from_GuitarSet_unet_model_trained_on_MAESTRO_.23 model_type=unet pretrained_model_path=results/unet_model_trained_on_GuitarSet/model-$epoches.pt epoches=$epoches seed=$seed train_size=.23
# python train.py with train_on=GuitarSet logdir=results_optional/transferred_from_MAESTRO_.23_unet_model_trained_on_GuitarSet model_type=unet pretrained_model_path=results_optional/unet_model_trained_on_MAESTRO_.23/model-$epoches.pt epoches=$epoches seed=$seed

# evaluate_model results_optional/transferred_from_GuitarSet_unet_model_trained_on_MAESTRO_.23/model-$epoches.pt
# evaluate_model results_optional/transferred_from_MAESTRO_.23_unet_model_trained_on_GuitarSet/model-$epoches.pt